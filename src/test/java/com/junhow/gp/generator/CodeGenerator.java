package com.junhow.gp.generator;
...
public class CodeGenerator {
    ...
    // JDBC配置
    private static final String JDBC_URL = "jdbc:mysql://127.0.0.1:3306/flowerdb?serverTimezone=GMT%2B8&useSSL=false&useUnicode=true&characterEncoding=UTF-8";
    private static final String JDBC_USERNAME = "root";
    private static final String JDBC_PASSWORD = "mysql";
    private static final String JDBC_DIVER_CLASS_NAME = "com.mysql.cj.jdbc.Driver";

    // 生成代码所在的基础包名称(这个配置修改之后需要手工修改src目录项目默认的包路径，使其保持一致，不然会找不到类)
    private static final String BASE_PACKAGE = "com.junhow.gp";
    // 生成的Model所在包
    ...
    public static void main(String[] args) {
        genCode( "family","flower",
                "genus","grade", "image", "permission", "phylum", "proposal", "role",
                "role_permission", "species", "subspecies","order","subspecies","user", "user_role");
    }
